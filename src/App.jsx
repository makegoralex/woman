...
const projectDetails = {
  ...
  "networking": {
    ...
    description: "Нетворкинг — направление для тех, кто хочет расширять круг общения осознанно и без случайной суеты. На встречах участники учатся коротко рассказывать о себе, формулировать запросы, находить точки пересечения и превращать знакомство в полезный контакт. Формат подходит для предпринимателей, экспертов, специалистов и всех, кому важны деловые связи, обмен опытом и поддерживающая среда. Здесь можно найти партнера для проекта, получить обратную связь, увидеть новые возможности и потренировать навык открытого, уважительного общения.",
  ...
  "sozdanie-meropriyatij": {
    ...
    description: "Создание мероприятий — практическое направление о том, как превращать идею встречи в понятный, красивый и полезный формат. Участники разбирают путь от цели события и портрета аудитории до сценария, тайминга, команды, площадки, партнеров, продвижения и пост-аналитики. Это пространство для тех, кто хочет организовывать деловые, образовательные, культурные или благотворительные события без хаоса и лишнего напряжения. В фокусе — смысл, атмосфера, забота о гостях и результат, который остается после мероприятия.",
  ...
  "intellekt-mental-health": {
    description: "Интеллектуальное развитие и ментальное здоровье — направление о ясности мышления, устойчивости и бережной работе с внутренним ресурсом. Здесь можно обсуждать привычки, которые помогают сохранять фокус, снижать перегрузку, лучше планировать день и восстанавливаться после интенсивных периодов. Форматы могут включать лекции, практические встречи, интеллектуальные дискуссии и упражнения на внимание. Главная идея направления — развиваться без давления, поддерживать интерес к знаниям и строить ритм жизни, в котором есть место и результатам, и спокойствию.",
  ...
  "business-i-zhenshina": {
    description: "Бизнес и развитие — направление для предпринимателей, экспертов и специалистов, которым важно расти системно. В центре внимания — стратегия, упаковка продукта, управление командой, личный бренд, партнерства, продажи и устойчивость в периоды изменений. Это не про жесткие схемы, а про осознанный выбор инструментов, обмен опытом и практические решения, которые можно применять в своем деле. Участники получают пространство для обсуждения идей, поиска точек роста, проверки гипотез и поддержки в профессиональном развитии.",
  ...
  "perezagruzka": {
    ...
    description: "Перезагрузка — мягкое направление для восстановления сил, внимания и внутреннего равновесия. Оно подходит тем, кто чувствует усталость от постоянной многозадачности, хочет сменить фокус, выдохнуть и вернуться к делам в более спокойном темпе. Встречи могут включать разговорные форматы, телесные и дыхательные практики, упражнения на осознанность и обсуждение привычек, которые помогают поддерживать ресурс каждый день. Здесь важны бережность, уважение к личному темпу и ощущение безопасного пространства.",
  ...
  "prazdnik-v-kazhdyj-dom": {
    description: "Праздник в каждый дом — благотворительное направление о внимании, заботе и маленьких событиях, которые делают жизнь теплее. Проект помогает объединять людей вокруг добрых инициатив: поддерживать семьи, создавать праздничную атмосферу, собирать подарки, организовывать творческие и городские форматы. Это направление для тех, кто хочет участвовать в социальных проектах не формально, а с живым человеческим смыслом. Важны простые действия, партнерство, прозрачность и ощущение, что вклад каждого может стать частью большого доброго результата.",
  ...
  "psihologiya-otnoshenij": {
    ...
    description: "Психология отношений — направление о коммуникации, границах, доверии и уважительном диалоге. Оно помогает лучше понимать себя и других, замечать повторяющиеся сценарии, говорить о потребностях спокойнее и выстраивать контакт без давления. Темы могут касаться семьи, партнерства, дружбы, рабочих отношений и отношения к самому себе. Формат подходит тем, кто хочет больше ясности в общении, меньше конфликтов и больше зрелой поддержки. В основе направления — практичность, бережность и внимание к реальным жизненным ситуациям.",
  ...
  "prekrasnaya-ya": {
    description: "Прекрасная Я — направление про образ, уверенность, самопрезентацию и бережное отношение к себе. Здесь внешний стиль рассматривается не отдельно, а вместе с внутренним состоянием, голосом, привычками и ощущением собственной ценности. Участники могут исследовать, как одежда, визуальная подача, речь и поведение помогают проявляться в жизни и работе спокойнее и точнее. Это пространство не про стандарты красоты, а про индивидуальность, уважение к себе и поиск образа, который поддерживает цели, характер и личный ритм.",
